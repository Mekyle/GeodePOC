...
const Main = (props: IMainProps) => (
  <div className="antialiased w-full text-gray-700 p-4 w-full h-screen">
    <section id="bottom-navigation" className="block fixed inset-x-0 bottom-0 z-10 bg-white shadow">
      <div id="tabs" className="flex justify-between">
        ...
        <Link href="/about/">
          <a
            href="#"
            className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1 text-black"
          >
            <svg width="25" height="25" viewBox="0 0 42 42" className="inline-block mb-1">
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <path
            ...
            <span className="tab tab-kategori block text-xs">Github</span>
          </a>
        </Link>
        <Link href="/about">
          <a
        ...
        <Link href="/timeline">
          ...
          >
            ...
            <span className="tab tab-kategori block text-xs">Timeline</span>
          </a>
        </Link>
      </div>
    </section>
    ...
    <div className="text-center py-8 text-sm">
      © Copyright {new Date().getFullYear()} {Config.title}. Powered by Edgeware{' '}
      {/*
